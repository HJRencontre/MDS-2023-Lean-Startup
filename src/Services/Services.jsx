    ...
    return (
        <>
            <div className="lg:grid grid-cols-2 items-center">
                <figure><img src="src/assets/images/emplacement.png" alt="Album"/></figure>
                <div className="card-body">
                    <h2 className="font-bold card-title text-lime text-2xl">Emplacement des lieux</h2>
                    <p className="text-justify">Partez à la découverte des théâtres à proximité de vous grâce à notre carte interactive ! Vous pourrez localiser les lieux et acheter des billets pour des spectacles dans votre région en toute simplicité.</p>
                </div>
            </div>
            <div className="lg:grid grid-cols-2 items-center">
                <div className="card-body">
                ...
                <figure><img src="src/assets/images/billetterie.png" alt="Album"/></figure>
            </div>
            <div className="lg:grid grid-cols-2 items-center">
                <figure>
                    <img src="src/assets/images/keepintouch.png" alt="Album"/>
                </figure>
